...
const Dashboard = () => {
  ...
  useEffect(() => {
    let isMounted = true; // Prevents updating state on an unmounted component if network is slow
  ...
  // 2. Memoized calculations to safeguard CPU cycles
    ...
    <section className="min-h-screen bg-ivory pt-24 sm:pt-28 pb-8 px-4 xs:px-3 sm:px-6 md:px-8 lg:px-10">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg p-4 xs:p-5 sm:p-7 md:p-8">
          <h1 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl font-bold text-burgundy wrap-break-word">
          ...
          <div className="flex flex-wrap gap-4 xs:gap-5 md:gap-6 mt-6 xs:mt-8 md:mt-10">
            <div className="flex-1 min-w-35 bg-gold/10 p-4 xs:p-5 sm:p-6 rounded-2xl">
            ...
            <div className="flex-1 min-w-35 bg-green-100 p-4 xs:p-5 sm:p-6 rounded-2xl">
              <h3 className="font-semibold text-sm xs:text-base sm:text-lg text-charcoal">
                Confirmed
              </h3>
            ...
            <div className="flex-1 min-w-35 bg-red-100 p-4 xs:p-5 sm:p-6 rounded-2xl">
              <h3 className="font-semibold text-sm xs:text-base sm:text-lg text-charcoal">
                Cancelled
              </h3>
        ...
        <div className="mt-6 sm:mt-8 w-full overflow-hidden rounded-2xl bg-white p-3 xs:p-4 sm:p-6 md:p-8 shadow-lg">
          <div className="flex flex-col xs:flex-row items-start xs:items-center justify-between gap-2 border-b border-gold/10 pb-3 xs:pb-4 mb-4 xs:mb-6">
            <h2 className="text-lg xs:text-xl sm:text-2xl md:text-3xl font-bold text-burgundy wrap-break-word">
              My Bookings
            </h2>
                ...
                <article
                  ...
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                    <div className="min-w-0 flex-1">
                      <h3 className="text-sm xs:text-base sm:text-lg font-semibold leading-snug text-charcoal wrap-break-word">
                        {booking.service}
                      </h3>
                      ...
                      <div className="mt-3 grid grid-cols-2 gap-2 xs:gap-3">
                        <div className="rounded-lg bg-ivory/70 px-3 py-2">
                          ...
                          <p className="text-xs xs:text-sm font-medium text-charcoal wrap-break-word">
                            {booking.date}
                          </p>
                        </div>
                        <div className="rounded-lg bg-ivory/70 px-3 py-2">
                      ...
                      {booking.message && (
                        <div className="mt-3 rounded-lg bg-ivory/70 p-3">
                          ...
                          <p className="text-xs xs:text-sm leading-relaxed text-charcoal/70 wrap-break-word  whitespace-pre-wrap">
                            {booking.message}
                          </p>
                        </div>
                      )}
                    ...
                    <div className="w-full md:w-auto md:min-w-32.5 md:max-w-45">
                      <span
                        className={`block w-full md:w-auto text-center rounded-full px-3 py-2 text-xs sm:text-sm font-semibold ${getStatusStyle(booking.status)}`}>
